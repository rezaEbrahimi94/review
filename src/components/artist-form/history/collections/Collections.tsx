...
const Collections = () => {
  ...
  return (
    <StylesStyled>
      <CardAccordion defaultExpanded={true}>
        ...
        <CardAccordionDetails>
          ...
          >
            ...
            <SamTable>
              ...
              {/* Table data */}
              <TableBody>
                {Collections.map((collection: TCollection, index: number) => {
                  return (
                    <TableRow key={index}>
                      <TableCell>
                        {collection.Artwork}
      ...
      <Box display={openDialog ? 'block' : 'none'}>
        <AddCollections onCloseEvt={handleDialogToggle} />
      </Box>
    </StylesStyled>
  )
}
